export const description = {
  ...
  hull_distance:
    'Deselect “Stable precursors only” checkbox<br> if you wish to edit “Distance of Hull”<br>`<br>This defines the energy range of metastable materials<br> for inclusion for inclusion in precursor library.',
  ...
  confine_to_stables:
    'Deselect “Stable precursors only” checkbox<br> if you wish to edit “Distance of Hull”.<br>`<br>This confines the precursor library<br> to thermodynamically stable materials in MP',
  confine_to_icsd:
